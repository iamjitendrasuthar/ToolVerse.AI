...
//           <button className="flex-1 flex items-center justify-center gap-2 py-2.5 bg-white border border-slate-200/80 hover:border-blue-200 hover:bg-blue-50/50 rounded-xl font-bold text-[13px] text-slate-700 transition-all shadow-sm hover:-translate-y-0.5 cursor-pointer">
