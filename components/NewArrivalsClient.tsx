...
export default function NewArrivalsClient({
  ...
  const [sortBy, setSortBy] = useState("Newest"); // Default sorted by Newest
  const [isSortOpen, setIsSortOpen] = useState(false);

  const sortOptions = ["Newest", "Popularity", "Highest Rated"];
    ...
    <main className="min-h-screen bg-[#fafcff] text-slate-900 overflow-hidden selection:bg-blue-200 selection:text-blue-900 pb-20">
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-4 md:px-6 pt-30 md:pt-32">
        ...
        <nav className="flex items-center gap-2 text-xs md:text-sm font-bold text-slate-400 mb-6 md:mb-8 overflow-x-auto whitespace-nowrap no-scrollbar">
          ...
          <span className="text-slate-900">New Arrivals</span>
        </nav>
        ...
        <header className="mb-10 md:mb-16">
          ...
          >
            <div className="max-w-2xl">
              <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-blue-50 border border-blue-100 text-blue-600 font-bold text-xs uppercase tracking-wider mb-4 md:mb-5">
              ...
              <p className="text-base md:text-lg text-slate-500 font-medium leading-relaxed">
                Discover the latest and most innovative AI tools that have just
                been added to our directory. Stay ahead of the curve.
              </p>
            </div>
            ...
            {filteredAndSortedTools.length === 0 ? (
              ...
              >
                ...
                <p className="text-sm md:text-base text-slate-500 font-medium px-4">
                  We are constantly adding new tools. Check back later!
                </p>
              </motion.div>
            ) : (
              <motion.div
